...
public class wjBFS{
	...
	public static void main(String args[])
	{
        ...
        System.out.println("Enter water content in jug1: ");
        Jug1 = sc.nextInt();
        System.out.println("Enter water content in jug2: ");
        Jug2 = sc.nextInt();
        System.out.println("Enter target water content : ");
        target = sc.nextInt();

		System.out.println("Path from initial state " +
				"to solution state ::");

        wjBFS object = new wjBFS();
